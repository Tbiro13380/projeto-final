                ...
                6030: function (e, t, i) {
                    ...
                    var f = {
                        keyEvent: function (e, t, i, c, u) {
                            ...
                            return (
                                (p.isComposing = k == n.keys.Process || k == n.keys.Unidentified),
                                            ...
                                            (n.getTest.call(c, e).match.nativeDef === t.charAt(0) ||
                                                ...
                                                (' ' === n.getTest.call(c, e).match.nativeDef &&
                                                    (n.getTest.call(c, e + 1).match.nativeDef ===
                                                        t.charAt(0) ||
                                                        (!0 ===
                                                            n.getTest.call(c, e + 1).match.static &&
                                                            n.getTest.call(c, e + 1).match
                                                                .nativeDef ===
                                                                "'" + t.charAt(0)))))
                                            ...
                                            if (-1 === M || 'string' == typeof M) {
                                                ...
                                                if (void 0 !== l.excludes[e]) {
                                                    for (
                                                        ...
                                                        o.length == B[1] &&
                                                            E.splice(E.indexOf(B[0]), 1)
                                                    }
                                                    0 === E.length &&
                                                        (delete l.excludes[e], (E = j))
                                                }
                                                ;(!0 === u.keepStatic ||
                                                ...
                                                for (var C = 0; C < E.length; C++) {
                                                    ;(_ = parseInt(E[C])),
                                                        (v = []),
                                                        (i =
                                                            ('string' == typeof M && m(h, _, w)) ||
                                                            T.slice())
                                                    var R = k.matches[_]
                                                    if (R && s(R, [_].concat(o), c)) r = !0
                                                    else if (
                                                        (0 === C && (S = !0),
                                                        R &&
                                                            R.matches &&
                                                    ...
                                                    for (var F = 0; F < a.length; F++) {
                                                        var L = a[F],
                                                            I = !1
                                                        ;(L.match.jit = L.match.jit || S),
                                                            (L.alternation = L.alternation || w),
                                                            x(L)
                                                ...
                                                r = s(
                                                    k.matches[M] || t.matches[M],
                                                    [M].concat(o),
                                                    c
                                                )
                                            if (r) return !0
                                        })()
                                    if (r.isQuantifier && c !== t.matches[t.matches.indexOf(r) - 1])
                                        return (function () {
                                            for (
                                                var n = r, c = !1, f = i.length > 0 ? i.shift() : 0;
                                                f <
                                                    (isNaN(n.quantifier.max)
                                                        ? f + 1
                                                        : n.quantifier.max) && h <= e;
                                                f++
                                            ) {
                ...
                7215: function (e, t, i) {
                    ...
                    function s(e, t, i, n, o, l) {
                        ...
                        if (
                            ...
                            for (; E >= 0; E--)
                                if ((p = S.validPositions[E]) && void 0 !== p.alternation) {
                        ...
                        if (void 0 !== u) {
                            ...
                            for (
                                -1 === D && void 0 !== t && (j.push(t), (D = j.length - 1));
